	...
	return (
		<nav id="navbar">
			...
			<ul id="navbar-links">
				...
				<li className="navbar-link"><a rel="noreferrer" target="_blank" href="https://docs.boosterbot.xyz/">Docs</a></li>
				{/* <li className="navbar-link"><NavLink activeClassName="active" to="/commands">Commands</NavLink></li> */}
				<li className="navbar-link"><a rel="noreferrer" target="_blank" href="https://boosterbot.xyz/support">Support Server</a></li>
				<li className="navbar-link"><a rel="noreferrer" target="_blank" href="https://boosterbot.xyz/vote">Vote</a></li>
